...
def make_features(*args, use_data=None, feature_parameters=None, **kwargs):
    ...
    feature_parameters: opetional, dict or None
        parameters to pass to individual features
    """
    if use_data is None:
    ...
    d = direction(a)
    feat = [
        f(magnitude=m, direction=d, acceleration=a, **feature_parameters)
